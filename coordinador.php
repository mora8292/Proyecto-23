      ...
      <div class="container">
          ...
          <div class="col-lg-8 col-sm-8">
            <div class="row">
              ...
              <div class="col-lg-9 col-sm-9">
                <label>
                  <h5><br> <?php include "info_coordinador.php" ?> </h5>
                  <hr>
                </label>
              </div>
            </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-sm-4 textlogin">
            <button class="btn btn_coordinador btn-secondary me-md-2 btn-g" type="button" onclick="Generar()"><img class=" img-fluid" src="imagenes/Generar_Evento.png" width="100px" height="40px"> </img>
              <p><b>Generador de Eventos</b></p>
            </button>
          </div>
          <div class="col-lg-2 col-sm-2">
          </div>
          <div class="col-lg-4 col-sm-4 textlogin">
            <button class="btn btn_coordinador btn-secondary me-md-2 btn-g" type="button" onclick="MEventos()"><img class=" img-fluid" src="imagenes/Calendario.png" width="100px" height="40px"> </img>
              <p><b>Mis Eventos</b></p>
            </button>
          </div>
          <div class="col-lg-1 col-sm-1">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-sm-4 textlogin">
            <button class="btn btn_coordinador btn-secondary me-md-2 btn-g" type="button" onclick="reportes()"><img class=" img-fluid" src="imagenes/Registro.png" width="100px" height="40px">
              <p><b>Reporte de Eventos</b></p>
            </button>
          </div>
          <div class="col-lg-2 col-sm-2">
          ...
          <div class="col-lg-4 col-sm-4 textlogin">
            <button class="btn btn_coordinador btn-secondary me-md-2 btn-g" type="button" onclick="scan()"><img class=" img-fluid" src="imagenes/scaner.png" width="100px" height="40px">
              <p><b>Scanner</b></p>
            </button>
