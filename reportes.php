...
?>
        ...
        <div class="row">
          ...
          <div class="col-lg-6 col-sm-6 ">
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="row">
                  <button id="excel" name="excel" type="submit" class="btn btn_coordinador btn-secondary me-md-2 btn-g" type="button"><img class=" img-fluid" src="imagenes/excel.png" width="40px" height="50px"> </img>
                    <p><b>Excel</b></p>
                  </button>
                </div>
                ...
                <div class="row">
                  <button id="pdf" name="pdf" type="submit" class="btn btn_coordinador btn-secondary me-md-2 btn-g" type="button"><img class=" img-fluid" src="imagenes/pdf.png" width="40px" height="50px"> </img>
                    <p><b>PDF</b></p>
                  </button>
                </div>
                <br>
                <div class="row">
                  <button id="reporte" name="reporte" type="submit" class="btn btn_coordinador btn-secondary me-md-2 btn-g" type="button"><img class=" img-fluid" src="imagenes/reporte.png" width="40px" height="50px"> </img>
                    <p><b> Reporte</b></p>
                  </button>
                </div>
                </form>
  ...
  <script>
    ...
    function cargarEventos() {
      ...
      $("#Eventos").html("<option>Cargando eventos...</option>");
      ...
      $.ajax({
        ...
        success: function(res) {
          ...
          if (res.length > 0) {
            ...
            $("#Eventos").html("<option value=''>No hay eventos disponibles</option>");
          }
        ...
        error: function(xhr, status, error) {
          ...
          $("#Eventos").html("<option value=''>Error al cargar eventos</option>");

          alertify.error("No fue posible obtener los eventos");
